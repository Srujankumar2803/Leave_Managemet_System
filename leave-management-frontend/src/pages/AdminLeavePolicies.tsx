    ...
    <div className="p-8">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
          ...
          <p className="mt-2 text-gray-600">Click "Add Leave Type" to create your first policy</p>
        </div>
      ) : (
        /* Leave types table */
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {leaveTypes.map((leaveType, index) => (
                <tr key={leaveType.id} className={`hover:bg-gray-100 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
